...
def dump_json_to_file(file_name, data_to_dump):
    ...
    with open(file_name, 'w') as outfile:
        json.dump(data_to_dump, outfile, sort_keys=True,
                  indent=4, separators=(',', ': '))


def one_hot_encode_y(label_array):
    """
    ...
    one_hot_y = np_utils.to_categorical(encoder.transform(label_array))

    return encoder, one_hot_y
